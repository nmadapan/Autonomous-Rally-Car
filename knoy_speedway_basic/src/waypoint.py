...
from global_constants import waypoints_rviz_path
...
class waypoint(object):
	...
	def get_way_point(self, msg):
		...
		self.waypoint_list.append([msg.pose.position.x, msg.pose.position.y, yaw])
		np.savez(waypoints_rviz_path, waypoints=np.array(self.waypoint_list))
